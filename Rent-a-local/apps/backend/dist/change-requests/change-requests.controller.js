...
const create_change_request_dto_1 = require("./dtos/create-change-request.dto");
const admin_guard_1 = require("../auth/guards/admin.guard");
const auth_guard_1 = require("../auth/guards/auth.guard");
let ChangeRequestsController = class ChangeRequestsController {
    changeRequestsService;
    constructor(changeRequestsService) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_change_request_dto_1.CreateChangeRequestDto]),
